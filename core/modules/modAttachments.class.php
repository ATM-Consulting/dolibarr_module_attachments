...
class modAttachments extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		//							'css' => array('/attachments/css/attachments.css.php'),	// Set this to relative path of css file if module has its own css file
...
*/
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=attachments',		// Put 0 if this is a single top menu or keep fk_mainmenu to give an entry on left
		//							'type'=>'top',			                // This is a Top menu entry
		//							'titre'=>'Attachments top menu',
		//							'mainmenu'=>'attachments',
		//							'leftmenu'=>'attachments_left',			// This is the name of left menu for the next entries
		...
		// $this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu=attachments,fk_leftmenu=attachments_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
		//							'type'=>'left',			                // This is a Left menu entry
		//							'titre'=>'Attachments left menu',
		//							'mainmenu'=>'attachments',
		//							'leftmenu'=>'attachments_left',			// Goes into left menu previously created by the mainmenu
...
/*
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=attachments',			                // Put 0 if this is a top menu
			'type'=>'left',			                // This is a Top menu entry
			'titre'=>$langs->trans('TopMenuAttachments'),
			'mainmenu'=>'attachments',
			'leftmenu'=>'attachments_left',
			'url'=>'/attachments/list.php',
			'langs'=>'attachments@attachments',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=>'$conf->attachments->enabled',	// Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled.
		...
		$this->menu[$r]=array(
			...
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuAttachmentsCreate'),
			'mainmenu'=>'attachments',
			'leftmenu'=>'attachments_left_create',
		...
		$this->menu[$r]=array(
			'fk_menu'=>'fk_mainmenu=attachments,fk_leftmenu=attachments_left',		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
			'type'=>'left',			                // This is a Left menu entry
			'titre'=>$langs->trans('LeftMenuAttachmentsList'),
			'mainmenu'=>'attachments',
			'leftmenu'=>'attachments_left_list',
			'url'=>'/attachments/list.php',
			'langs'=>'attachments@attachments',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
			'position'=>100+$r,
			'enabled'=> '$conf->attachments->enabled',  // Define condition to show or hide menu entry. Use '$conf->missionorder->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
